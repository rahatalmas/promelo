    ...
    <>
      <div className="footer-container">
        ...
        <div className="footer-texts">
          <p>221 Main Street, Suite 770, San Francisco, CA 94105</p>
          <p>
          ...
          <h3>Pomelo Privacy Policy</h3>
          <h3>Coastal Community Bank Privacy Policy</h3>
          <h3>Pomelo Account Card Holder Agreement</h3>
          <h3>©2023 Pomelo</h3>
        </div>
      </div>
    </>
